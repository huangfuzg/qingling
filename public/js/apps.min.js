...
var handleHeaderFixedTop = function() {
   ...
   pc_TurnImgs = function(cata) {
	...
	product_Content = function(cata,pname){
		$.getJSON("parameter/"+pname+".json", "", function(data) {
       		console.log(data);
       		for (var i = data.length - 1; i >= 0; i--) {
       			//console.log(data[i]);
				if(data[i].id === cata)
				{
					...
					console.log(para);
					// if(pname=="network_cable"){
					// 	if(cata==="05"){
					// 		var str = '<table class="table table-bordered"><thead><tr><th colspan="2" style="text-align: center;">'+name+'</th></tr>\
					// 			</thead><tbody><tr><th>Conductor Size</th><td></td></tr>\
					// 			<tr><th>Conductor Material</th><td></td></tr>\
					// 			<tr><th>Number Of Conductor</th><td></td></tr>\
					// 			<tr><th>Shield</th><td></td></tr>\
					// 			<tr><th>Flammability Grade</th><td></td></tr>\
					// 			<tr><th>Indoor/Outdoor</th><td></td></tr>\
					// 			<tr><th>Insulation Material</th><td></td></tr>\
					// 			<tr><th>Insulation Thickness</th><td></td></tr>\
					// 			<tr><th>Outer Jacket Thickness</th><td></td></tr>\
					// 			<tr><th>DC Resistance(Max.)</th><td></td></tr>\
					// 			<tr><th>DC Resistance Imbalance</th><td></td></tr>\
					// 			<tr><th>Working Capacitance(Max.)</th><td></td></tr>\
					// 			<tr><th>Insulation Resistance</th><td></td></tr>\
					// 			<tr><th>Transmission Velocity</th><td></td></tr>\
					// 			<tr><th>Operating Temperature</th><td></td></tr>\
					// 			<tr><th>PVC Jacket Color</th><td></td></tr>\
					// 			<tr><th>Marking On Jacket</th><td></td></tr>\
					// 			</tbody></table>';
     //                       // console.log(str);
     //                        var a = $('#product-desc');
     //                        a.append(str);
     ...
     //                    if(cata=="06"){
					// 		var str = '<table class="table table-bordered"><thead><tr><th colspan="2" style="text-align: center;">'+name+'</th></tr>\
					// 			</thead><tbody><tr><th>Item</th><td></td></tr>\
					// 			<tr><th>Connector</th><td></td></tr>\
					// 			<tr><th>Conductor</th><td></td></tr>\
					// 			<tr><th>Molding Type</th><td></td></tr>\
					// 			<tr><th>AWG</th><td></td></tr>\
					// 			<tr><th>Insulation</th><td></td></tr>\
					// 			<tr><th>Length</th><td></td></tr>\
					// 			<tr><th>Shielding</th><td></td></tr>\
					// 			<tr><th>Packaging</th><td></td></tr>\
					// 			<tr><th>Supported resolutions</th><td></td></tr>\
					// 			<tr><th>Certificate</th><td></td></tr>\
     ...
     //                    }
     //                    else{
     //                    	var str = '<table class="table table-bordered"><thead><tr><th colspan="2" style="text-align: center;">'+name+'</th></tr></thead>\
					// 			<tbody><tr><th>Standard</th><td></td></tr>\
					// 			<tr><th>Connector</th><td></td></tr>\
					// 			<tr><th>Wire No</th><td></td></tr>\
					// 			<tr><th>Color</th><td></td></tr>\
					// 			<tr><th>Length</th><td></td></tr>\
					// 			<tr><th>Suit cable</th><td></td></tr>\
					// 			<tr><th>Certificate</th><td></td></tr>\
					// 			<tr><th>Shield</th><td></td></tr>\
					// 			<tr><th>Stretching Resistance</th><td></td></tr>\
	...
	App = function() {
		...
		return {
			init_mpowercord:function() {
				...
				mobileNav(),pc_title(type),pc_insertNav(type),pc_mTurnImgs(type),pc_insertContent(type),pc_insertLineImgs(type);
			},
			...
			init_pc: function(){
				...
				mobileNav(),pc_title(type),pc_TurnImgs(type),pc_insertContent(type),pc_insertLineImgs(type),show_sidebar(type,pname,cata);
				//$('.pgwSlideshow').pgwSlideshow(option);
			},
			init_other: function(){
				var type = getUrlParam("type");
