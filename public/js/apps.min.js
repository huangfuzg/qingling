		...
		$.getJSON("data/ac_power.json", "", function(data) {
			for (var i = data.length - 1; i >= 0; i--) {
				...
				if(data[i].id === cata)
				{
					...
					var a = $('.breadcrumb');
					console.log(a);
					var str = '<li><a href="#">ac_power</a></li>'
					a.append(str);
				...
				if(data[i].id === cata)
				{
					...
					$.each(content,function(i,item){
						...
						if(i%2===0){
                          ...
                          </div><div class="desc"><ul class="product-info-list1" id="'+i+'">\
							</ul></div></div>'
							a.append(str);
							var id = "#" + i;
							console.log(id)
						...
						if(i%2===1){
							...
							<div class="image"><img src="'+imgurl+'" alt="" />\
                          </div><div class="desc"><ul class="product-info-list2" id="'+i+'">\
							</ul></div></div>'
							a.append(str);
							var id = "#" + i;
							//console.log(id);
	...
	App = function() {
		...
		return {
			init: function() {
				...
				// var type = "01";
				handleProductImage(),handleNavBar(),insertContent(type),insertLineImgs(type),insertTurnImgs(type),insertNav(type);
			},
			initline: function(){
        ...
        console.log(type,pname);
				handleProductImage(),handleNavBar(),productTurnImgs(type,pname),productContent(type,pname),productNav(type,pname)
			}
		}
	}();
